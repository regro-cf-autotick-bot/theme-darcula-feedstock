...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/theme-darcula-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12448&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/theme-darcula-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `theme-darcula` can be installed with:

```
conda install theme-darcula
```

It is possible to list all of the versions of `theme-darcula` available on your platform with:
